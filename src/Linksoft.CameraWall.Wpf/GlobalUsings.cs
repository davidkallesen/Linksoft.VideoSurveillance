...
global using MediaCleanupDirectoryResult = Linksoft.VideoSurveillance.Helpers.MediaCleanupDirectoryResult;
global using MediaCleanupResult = Linksoft.VideoSurveillance.Models.MediaCleanupResult;
global using MediaCleanupRunError = Linksoft.VideoSurveillance.Helpers.MediaCleanupRunError;
global using MediaCleanupRunner = Linksoft.VideoSurveillance.Helpers.MediaCleanupRunner;
global using MediaCleanupRunResult = Linksoft.VideoSurveillance.Helpers.MediaCleanupRunResult;
...
global using UsbCameraEventArgs = Linksoft.VideoSurveillance.Events.UsbCameraEventArgs;